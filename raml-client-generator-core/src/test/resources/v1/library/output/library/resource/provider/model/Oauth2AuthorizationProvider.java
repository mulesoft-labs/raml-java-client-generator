...
public class Oauth2AuthorizationProvider {
     ...
     * @param url
     */
    public Oauth2AuthorizationProvider(String name, String url) {
        super();
        this.name = name;
        this.url = url;
    }
    ...
    public Oauth2AuthorizationProvider withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Oauth2AuthorizationProvider withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public Oauth2AuthorizationProvider withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Oauth2AuthorizationProvider) == false) {
            return false;
        }
        Oauth2AuthorizationProvider rhs = ((Oauth2AuthorizationProvider) other);
