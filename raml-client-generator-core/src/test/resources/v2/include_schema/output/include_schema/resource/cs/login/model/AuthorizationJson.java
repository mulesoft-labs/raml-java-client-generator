...
package include_schema.resource.cs.login.model;
...
public class AuthorizationJson {
     ...
     * @param updatedAt
     */
    public AuthorizationJson(Date createdAt, Date updatedAt, Date lastUsed, String userId, String clientId, String domain, List<String> scopes) {
        super();
    ...
    public AuthorizationJson withCreatedAt(Date createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public AuthorizationJson withUpdatedAt(Date updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public AuthorizationJson withLastUsed(Date lastUsed) {
        this.lastUsed = lastUsed;
        return this;
    }
