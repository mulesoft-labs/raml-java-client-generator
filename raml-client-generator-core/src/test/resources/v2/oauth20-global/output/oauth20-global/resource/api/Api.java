...
import oauth20-global.resource.api.model.ApiGETResponseBody;
import oauth20-global.responses.CoreServicesAPIReferenceResponse;
...
new javax.ws.rs.core.GenericType<java.util.List<oauth20-global.resource.api.model.ApiGETResponseBody>>() {})), response.getStringHeaders(), response);
        return apiResponse;
    }
